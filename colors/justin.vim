...
hi clear Normal		ctermbg=Black  ctermfg=lightgreen guibg=Black		 guifg=lightgreen
...
hi StatusLine	term=reverse,bold cterm=reverse   gui=NONE		guifg=black guibg=#888888
hi StatusLineNC term=reverse   cterm=reverse	  gui=NONE		guifg=white guibg=#333333
hi Title		term=bold	   ctermfg=LightMagenta gui=bold	guifg=Pink
hi WarningMsg	term=standout  ctermfg=LightRed   guifg=Red
hi Visual		term=reverse   cterm=reverse	  gui=NONE		guifg=white guibg=darkgreen
hi Folded       term=standout   ctermfg=lightcyan   ctermbg=none   guifg=Black  guibg=#888888
hi SpellBad     cterm=underline    ctermbg=red ctermfg=yellow guifg=red  gui=underline,bold
